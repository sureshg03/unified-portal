...
export const LoginPage = ({ onLogin }: LoginPageProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!lscNumber || !password) {
      toast({
        title: "ΓÜá∩╕Å Missing Information",
    ...
    try {
      ...
      let errorTitle = "≡ƒöÆ Login Failed";
