...
const StudentApplicationView.FC = () => {
  ...
  const formatAddress = (type: 'comm' | 'perm') => {
  ...
  if (!student) {
    return (
      <>
        ...
        <> navigate(-1)}
          className="px-6 py-2 bg-indigo-600 text-white rounded-lg hover-indigo-700"
        >
          Go Back
        <>
      <>
